...
import { createHIPAA } from "../graphql/mutations";
const client = generateClient();
export default function HIPAACreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      columnGap="15px"
      padding="20px"
      onSubmit={submitHIPAACreateForm }
      {...getOverrideProps(overrides, "HIPAACreateForm")}
      {...rest}
    >
      <Text
...
export async function submitHIPAACreateForm(event) {
        ...
        try {
          ...
          await client.graphql({
            query: createHIPAA.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },

...
export default createTheme({
  ...
  tokens: {
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(215, 100%, 81%)" },
          20: { value: "hsl(215, 100%, 77%)" },
          40: { value: "hsl(215, 100%, 69%)" },
          60: { value: "hsl(215, 100%, 61%)" },
          80: { value: "hsl(215, 64%, 49%)" },
          90: { value: "hsl(215, 64%, 37%)" },
          100: { value: "hsl(215, 64%, 31%)" },
        },
        secondary: {
          10: { value: "hsl(210, 25%, 75%)" },
          20: { value: "hsl(209, 25%, 69%)" },
          40: { value: "hsl(210, 25%, 59%)" },
          60: { value: "hsl(210, 26%, 49%)" },
          80: { value: "hsl(210, 26%, 39%)" },
          90: { value: "hsl(209, 26%, 29%)" },
          100: { value: "hsl(209, 26%, 25%)" },
        },
      },
      font: {

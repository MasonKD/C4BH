...
import { MyIconProps } from "../../ui-components/MyIcon";
...
export declare type SideNavModOverridesProps = {
...
export declare type SideNavPModrops = React.PropsWithChildren<Partial<FlexProps> & {
    state?: "closed" | "mobile" | "open";
} & {
    overrides?: SideNavModOverridesProps | undefined | null;
}>;
export default function SideNavMod(props: SideNavModProps): React.ReactElement;
